    ...
    >
      ...
      <div className="absolute bottom-0 w-full p-8">
        ...
        >
          ...
          <p className="text-gray-300 text-sm mb-3">${product.price}</p>
          <p className="text-gray-400 text-base leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            {product.description}
          </p>
          <button className="mt-4 px-6 py-2 bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 text-blue-400 rounded-xl text-sm font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.5)]">
            View Details
          </button>
        </motion.div>
      </div>
